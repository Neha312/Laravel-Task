...
<body>
    ...
    <div class="container-fluid">
        <h1 class="text-center  text-danger py-4">Restore Articales</h1>
        <table class="table">
            <a class="btn btn-success" href="restoreAll"><i class='bi bi-archive-fill'></i>Restore All</a>
            <thead>
                <tr>
                    <th scope="cols">ID</th>
            ...
            <tbody>
                @foreach ($articals as $artical)
                    <tr>
                        ...
                        <td><a href="restore/{{ $artical->id }}" class="text-primary btn"><i
                                    class='bi bi-archive-fill'></i>Restore</td>
